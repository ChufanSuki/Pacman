...
from pacman.algorithms import ComputationDef, load_algorithm_module
from pacman.dcop.objects import Variable
from pacman.utils.simple_repr import SimpleRepr, SimpleReprException, simple_repr
...
class MessagePassingComputation(object, metaclass=ComputationMetaClass):
    ...
    def __init__(self, name: str, *args, **kwargs):
        ...
        # sub-classes.
        self.logger = logging.getLogger("pacman.computation." + self.__class__.__name__)
...
class DcopComputation(MessagePassingComputation):
    ...
    def __init__(self, name, comp_def: ComputationDef):
        ...
        self.logger = logging.getLogger(f"pacman.algo.{self.algo_name}.{name}")
