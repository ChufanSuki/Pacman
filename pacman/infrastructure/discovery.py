...
The unit tests in `test_discovery.py` gives many example of the
...
class DirectoryComputation(MessagePassingComputation):
    ...
    def __init__(self, directory: 'Directory'):
        ...
        self.logger = logging.getLogger('pacman.discovery.directory')
...
class Discovery(object):
    ...
    def __init__(self, agent_name: AgentName, address: Address):
        ...
        self.logger = logging.getLogger('pacman.discovery.'+agent_name)
