...
from pacman.infrastructure.agents import ResilientAgent
from pacman.infrastructure.communication import CommunicationLayer, MSG_VALUE, MSG_MGT
from pacman.infrastructure.computations import (
    MessagePassingComputation,
    Message,
    build_computation,
)
from pacman.infrastructure.discovery import Address
from pacman.infrastructure.orchestrator import (
    DeployMessage,
    RunAgentMessage,
...
class OrchestrationComputation(MessagePassingComputation):
    ...
    def __init__(self, agent: OrchestratedAgent):
        ...
        self.logger = logging.getLogger("pacman.agent.mgt." + agent.name)
        self._handlers = {
