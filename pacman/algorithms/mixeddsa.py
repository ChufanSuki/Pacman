...
from pacman.dcop.relations import RelationProtocol, generate_assignment_as_dict, \
    filter_assignment_dict

from pacman.algorithms import AlgoParameterDef, ComputationDef
from pacman.infrastructure.computations import Message, VariableComputation, \
    register
...
class MixedDsaComputation(VariableComputation):
    ...
    def __init__(self, variable, constraints, variant='B', proba_hard=0.7,
        ...
        # We do not use pacman.dcop.relations.find_optimum() to distinguish
