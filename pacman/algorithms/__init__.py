...
The ``pacman.algorithms`` module  contains the implementation of all DCOP
algorithm supported by Pacman.
...
``pacman.algorithms`` also defines objects and functions that are used
...
from pacman.utils.simple_repr import SimpleRepr, simple_repr, from_repr
...
class AlgorithmDef(SimpleRepr):
    ...
    algo: str
        ...
        in the :mod:`pacman.algorithms` package.
    params: dict
...
def list_available_algorithms() -> List[str]:
    ...
    root_algo = import_module('pacman.algorithms')
...
def load_algorithm_module(algo_name: str):
    ...
    algo_module = import_module('pacman.algorithms.'+algo_name)
...
def find_computation_implementation(algorithm_module):
    ...
    from pacman.infrastructure.computations import VariableComputation
    implementations = []
