...
from pacman.dcop.objects import VariableNoisyCostFunc, Variable
from pacman.algorithms import AlgoParameterDef, ComputationDef
from pacman.algorithms import maxsum
from pacman.dcop.relations import generate_assignment_as_dict
...
logger = logging.getLogger("pacman.maxsum")
