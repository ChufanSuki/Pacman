...
:ref:`distribute<pacman_commands_distribute>` command
(and is automatically built when using the :ref:`solve<pacman_commands_solve>` command).
...
::
    ...
    pacman -algo dpop graph_coloring_eq.yaml
...
from pacman.computations_graph.pseudotree import get_dfs_relations
from pacman.infrastructure.computations import Message, VariableComputation, register
...
from pacman.algorithms import ALGO_STOP, ALGO_CONTINUE, ComputationDef
