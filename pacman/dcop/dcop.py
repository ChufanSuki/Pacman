...
from pacman.dcop.objects import AgentDef, Variable, VariableDomain, \
    ExternalVariable, Domain
from pacman.dcop.relations import RelationProtocol, constraint_from_str, \
...
class DCOP(object):
    ...
    In pacman, a DCOP does not contains the mapping \mu as this mapping
