...
::
  ...
  pacman batch <batches_description_file>
...
It can be used to generate many DCOP of a given kind (using the pacman generate command)
...
logger = logging.getLogger("pacman.cli.batch")


def set_parser(subparsers):

    logger.debug("pacman batch ")
