...
::
    ...
    pacman generate [--output <file>] <problem-type> ...
...
from pacman.commands.generators import graphcoloring, meetingscheduling, ising, agents, \
    scenario
from pacman.commands.generators.iot import generate_iot
from pacman.commands.generators.secp import generate_secp, parser_secp
from pacman.commands.generators.smallworld import generate_small_world
from pacman.dcop.objects import VariableDomain, Variable, AgentDef
from pacman.dcop.dcop import DCOP
from pacman.dcop.relations import relation_from_str
...
def run_cmd(args):
    print(
        '"pacman generate" can generate several kind of dcop\n'
        'Run "pacman generate graphcoloring --help" or \n'
        '    "pacman generate mixed_problem --help"  \n'
        "for help"
    )
